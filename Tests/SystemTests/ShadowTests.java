...
/**
	 * Sphere-Triangle shading - move triangle up-right
 	 * Implemented by moving the X axis + 10
 	 * by moving the Y axis - 10
	 */
	...
	public void SphereTriangleMove1() {
		...
		scene.addGeometries(new Sphere(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
				60, new Point3D(0, 0, 200)), //
				new Triangle(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
						new Point3D(-70 + 10, 40 - 10, 0), new Point3D(-40 + 10, 70 - 10, 0), new Point3D(-68 + 10, 68 - 10, 4)));
...
/**
	 * Sphere-Triangle shading - move triangle upper-righter
 	 * Implemented by moving the X axis + 20
 	 * by moving the Y axis - 20
	 */
	...
	public void SphereTriangleMove2() {
		...
		scene.addGeometries(new Sphere(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
				60, new Point3D(0, 0, 200)), //
				new Triangle(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
						new Point3D(-70 + 20, 40 - 20, 0), new Point3D(-40 + 20, 70 - 20, 0), new Point3D(-68 + 20, 68 - 20, 4)));
...
/**
	...
	public void SphereTriangleSpot1() {
		...
		scene.addLights(new SpotLight(new Color(400, 240, 0), //
				new Point3D(-100 + 20, 100 - 20, -200 + 90), new Vector(1, -1, 3), 1, 1E-5, 1.5E-7));
...
/**
	...
	public void SphereTriangleSpot2() {
		...
		scene.addLights(new SpotLight(new Color(400, 240, 0), //
				new Point3D(-100 + 28, 100 - 28, -200 + 140), new Vector(1, -1, 3), 1, 1E-5, 1.5E-7));
